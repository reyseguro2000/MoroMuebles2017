Public Class opcion_Contrato
    ...
    Private Sub opcion_Contrato_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        Dim conexion As New base_local
